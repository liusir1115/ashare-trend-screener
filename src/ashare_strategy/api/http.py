...
from ashare_strategy.core import BacktestEngine, DailyBar, DailySnapshot, ScreeningEngine, StrategyConfig
from ashare_strategy.services.mvp_page_service import build_mvp_payload
...
frontend_dir = _resolve_frontend_dir() if app is not None else None
if app is not None and frontend_dir is not None:
